...
import { variables, changes, intervals, permissions, } from "../other/variables.js";
    ...
    up: {
        gearUp(car = myCar) {
            ...
            if (currentRpm > 800) {
                switch (car) {
                    case myCar:
                        let averageRpmDiminishing = Math.round((myCar.rpm - currentRpm) / 10);
                        $(".rpm-counter").css({
                            transition: ".5s",
...
//# sourceMappingURL=gearFunctions.js.map