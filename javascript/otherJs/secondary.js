...
function useLocalStorageAndCookies() {
  if (!localStorage.getItem("device")) {
    ...
    if (isThereAKeyboard) {
      alert(
        'У частині "вступ" розказане управління, яке в меню паузи ви можете відкоригувати і там же і змінити налаштування по девайсу. Приємної гри!'
      );
      device = "computer";
      localStorage.setItem("device", device);
    } else {
      alert(
        "Прошу тримати свій девайс в горизонтальному положенні для зручності. Якщо ви ввели не те - в меню паузи можна змінити налаштування щодо девайсу"
      );
      device = "phone";
    }
    localStorage.setItem("device", device);
