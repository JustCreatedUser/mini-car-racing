            ...
            setTimeout(() => {
                ...
                switch (raceIndex) {
                    ...
                    case 2:
                        ...
                        firstRace.beginning(firstRace.tip, "<div class='enemy-car firstRace'><img src='./icons-and-images/wheel.webp' alt='' class='wheel one enemy-wheel'><img src='./icons-and-images/flame.png' class='flame enemy-flame'><img src='./icons-and-images/wheel.webp' alt='' class='wheel two enemy-wheel'/><img src='./icons-and-images/cars/firstRace.webp' alt='car' class='vehicle enemy-vehicle' /></div>", variables.language == "ukrainian"
                    ...
                    case 3:
                        $("#race").css({ transform: "scale(1.5)", marginLeft: "20vw" });
                        secondRace.beginning(secondRace.tip, "<div class='enemy-car secondRace'><img src='./icons-and-images/wheel.webp' alt='' class='wheel one enemy-wheel'><img src='./icons-and-images/flame.png' class='flame enemy-flame'><img src='./icons-and-images/wheel.webp' alt='' class='wheel two enemy-wheel'/><img src='./icons-and-images/cars/secondRace.webp' alt='car' class='vehicle enemy-vehicle' /></div>", variables.language != "english"
                    ...
                    case 4:
                        $("#race").css({ transform: "scale(1.5)", marginLeft: "20vw" });
                        finalRace.beginning(secondRace.tip, "<div class='enemy-car finalRace'><img src='./icons-and-images/wheel.webp' alt='' class='wheel one enemy-wheel'><img  src='./icons-and-images/flame.png' class='flame enemy-flame'><img src='./icons-and-images/wheel.webp' alt='' class='wheel two enemy-wheel'/><img src='./icons-and-images/cars/finalRace.webp' alt='car' class='vehicle enemy-vehicle' /></div>", variables.language != "english"
