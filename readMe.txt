...
Загалом Mini-car racing - це онлайн гра, створена в розважальних цілях. 
В ній присутня:
...
Версія 6.0 - 6.1 - МАКСИМАЛЬНА СПІШКА (дедлайн розробки перенесли на 1 місяць вперед){
  ...
  Версія 6.5 (30.05.2024) - Трохи дописав десь код (доробив).
